...
export class UI {
  ...
  showAlert(message, className) {
    ...
    setTimeout(() => {
      //uyarıyı ekrandan silme fonksiyonunu shoswAlert fonkdiyonu çalıştıktan 3 saniye sonra çalıştir
      this.clearAlert();
    }, 3000);
  }
  ...
  <div class="col-6">
    <span class="badge bg-secondary">Yıldız:${repo.stargazers_cuont}</span>
